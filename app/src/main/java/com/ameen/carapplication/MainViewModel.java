...
public class MainViewModel extends ViewModel {
    ...
    public MutableLiveData<CarModule> carResponse = new MutableLiveData();
    ...
    public void getCars() {
        ...
        apiService.getCars(1).enqueue(new Callback<CarModule>() {
            @Override
            public void onResponse(Call<CarModule> call, Response<CarModule> response) {
                carResponse.postValue(response.body());
            }

            @Override
            public void onFailure(Call<CarModule> call, Throwable t) {
